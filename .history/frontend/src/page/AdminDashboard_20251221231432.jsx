          ...
          {products.map((p) => {
            ...
            return (
              <tr key={p.id} style={{borderBottom: "1px solid #ddd"}}>
                ...
                <td style={{ padding: "12px", color: isLowStock ? "#dc3545" : "#28a745", fontWeight: "bold" }}>
      ...
      {showModal && (
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{marginTop: 0, marginBottom: "15px"}}>Add Stock</h3>
            <p style={{color: "#666", marginBottom: "15px"}}>SKU: <strong>{selectedSku}</strong></p>
